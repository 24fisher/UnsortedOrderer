...
- `DriversFolderName` — имя подпапки для драйверов (поиск слова `driver` в имени файла/папки/архива).
...
- Драйверы ищутся по ключевому слову `driver` в названиях файлов и папок и обрабатываются как программы, но складываются в отдельный каталог.
